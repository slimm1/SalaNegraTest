...
public class InputValidation {
    ...
    public static boolean validateLogin(String username, String password){
        ...
        if(username.isBlank() || password.isBlank()){
            JOptionPane.showMessageDialog(null, "Debes completar todos los campos para continuar", "ALERTA",JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    public static boolean validateRegister(String name, String surname, String email, Date birthDate, String gender, String username, String pass, String repeatPass){
        if(name.isBlank() || surname.isBlank() || email.isBlank() || birthDate == null || gender == null || username.isBlank() || pass.isBlank() || repeatPass.isBlank()){
            ...
            JOptionPane.showMessageDialog(null, "Las contraseñas no coinciden", "ALERTA", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        else if(MongoUserHandler.getInstance().getUserByEmail(email)!=null){
            JOptionPane.showMessageDialog(null, "Ya existe un usuario con el email indicado", "ALERTA", JOptionPane.ERROR_MESSAGE);            
            return false;
        }
        else if(MongoUserHandler.getInstance().getUserByUsername(username)!=null){
            JOptionPane.showMessageDialog(null, "Ya existe un usuario con ese nombre de usuario", "ALERTA", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
    }
